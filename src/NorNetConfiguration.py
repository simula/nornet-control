...
from ipaddress import ip_address, IPv4Address, IPv4Network, IPv4Interface, IPv6Address, IPv6Network, IPv6Interface;
...
def loadNorNetConfiguration(includeAPIConfiguration = True, quietMode = False):
   ...
   if IPv4Network(NorNet_Configuration['NorNet_IPv4Prefix']).prefixlen > 8:
   ...
   if IPv6Network(NorNet_Configuration['NorNet_IPv6Prefix']).prefixlen > 48:
   ...
   if IPv4Network(NorNet_Configuration['NorNet_IPv4TunnelPrefix']).prefixlen > 16:
   ...
   if IPv6Network(NorNet_Configuration['NorNet_IPv6TunnelPrefix']).prefixlen > 80:

...
def makeTunnelBoxConfiguration(fullSiteList, localSite, configNamePrefix, v4only):
   ...
   outputFile.write('      sysctl -w net.ipv4.conf.default.rp_filter=0 || true\n')
   outputFile.write('      sysctl -w net.ipv4.conf.all.rp_filter=0 || true\n')
   outputFile.write('      for interface in $INTERFACES ; do\n')
   outputFile.write('         sysctl -w net.ipv4.conf.$interface.rp_filter=0 || true\n')
